...
# resource "unifi_firewall_rule" "service_info" {
#   site = local.site_name
...
#   protocol         = "tcp"
#   src_address      = "0.0.0.0"
#   src_port         = "32768-65535"
#   src_network_type = "NETv4"
#   dst_address      = var.public_ip
#   dst_port         = tostring(var.usg_port)
...
resource "unifi_firewall_rule" "service_info_lan_local" {
  site = local.site_name
...
resource "unifi_firewall_rule" "service_info_lan_in" {
  site = local.site_name
