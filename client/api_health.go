...
func (r ApiHealthzRequest) Execute() (*Health, *http.Response, error) {
	return r.ApiService.HealthzExecute(r)
}

/*
Healthz Get health information about the service.
...
//  @return Health
func (a *HealthAPIService) HealthzExecute(r ApiHealthzRequest) (*Health, *http.Response, error) {
	var (
